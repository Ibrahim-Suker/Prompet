# 🧠 بروتوكولات هندسة البرمجيات — Engineering Protocols

<div dir="rtl">

> مجموعة بروتوكولات متكاملة لتخطيط وتنفيذ وتعديل المشاريع البرمجية بجودة إنتاجية عالية.

---

## 📋 الفهرس

- [١. برومبت التخطيط المطوّر](#١-برومبت-التخطيط-المطوّر-the-planning-protocol)
- [٢. برومبت التنفيذ المطوّر](#٢-برومبت-التنفيذ-المطوّر-the-execution-engine)
- [٣. برومبت التعديل المطوّر](#٣-برومبت-التعديل-المطوّر-surgical-editing-protocol)

---

## ١. برومبت التخطيط المطوّر (The Planning Protocol)
...
> **مهم جدًا:** حدد السنة والشهر من النظام باستخدام shell. إذا نجحت في ذلك ابحث في المستودعات الرسمية (npm, GitHub) عن أحدث الإصدارات المستقرة إلى هذا التاريخ.
...
| القسم | الوصف |
|-------|-------|
| `[TECH_STACK]` | التقنيات المستخدمة وإصداراتها |
| `[SYSTEM_FLOW]` | تدفق النظام ورحلة المستخدم |
| `[ARCHITECTURE]` | البنية المعمارية للمشروع |
| `[ORPHANS & PENDING]` | تتبع النواقص والعناصر غير المكتملة |

---

### ✅ الموجز المطلوب

قدم المخرجات أعلاه بلغة تقنية مكثفة ودقيقة جداً، مع خطة عمل **(Milestones)** تعتمد **"نجاح الأهداف" (Verifiable Goals)**. انتظر الموافقة.

---

## ٢. برومبت التنفيذ المطوّر (The Execution Engine)
...
ابدأ التنفيذ التسلسلي الآن. لكل خطوة:

```
1. نفذ  →  2. تحقق  →  3. حدّث الخريطة
```

> لا تتوقف حتى يصبح قسم `[ORPHANS & PENDING]` فارغاً والمنتج كاملاً.

---

## ٣. برومبت التعديل المطوّر (Surgical Editing Protocol)
...
نفذ البروتوكولات بشكل مستمر. ابدأ بـ **تحليل التأثير** وذكر الافتراضات **(Think Before Coding)**، ثم انتقل للتنفيذ الجراحي المباشر.

---

<div align="center">

**صُمِّمت هذه البروتوكولات لضمان جودة إنتاجية عالية، وصيانة سهلة، وتوسعية آمنة.**
